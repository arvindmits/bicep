...
namespace Bicep.Core.TypeSystem
{
    public class ResourceTypeFactory
    {
        ...
        private TypeProperty GetTypeProperty(string name, Types.Concrete.ITypeReference input)
            => new TypeProperty(name, GetTypeReference(input), TypePropertyFlags.None);
        ...
        private TypeSymbol ToTypeSymbol(Types.Concrete.TypeBase typeBase)
        {
            switch (typeBase)
            {
                ...
                case Types.Concrete.ObjectType objectType:
                {
                    ...
                    var properties = objectType.Properties ?? new Dictionary<string, Types.Concrete.ITypeReference>();
        ...
        private NamedObjectType ToCombinedType(IEnumerable<KeyValuePair<string, Types.Concrete.ITypeReference>> baseProperties, string name, Types.Concrete.ITypeReference extendedType)
        {
